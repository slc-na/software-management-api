...
export class SoftwareOnRoomsService {
  ...
  async bulkUpdateSoftwareByRoom(params: BulkUpdateSoftwareByRoomInput) {
    this.repository.updateSoftwareByRoom(params);
    return params.data.length
  }

  async bulkUpdateRoomBySoftware(params: BulkUpdateRoomBySoftwareInput) {
    this.repository.updateRoomBySoftware(params);
    return params.data.length
  }
